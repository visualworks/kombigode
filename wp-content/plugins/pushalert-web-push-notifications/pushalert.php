...
function pushalert_admin_init() {
    $pa_version = "2.1";
    wp_register_style('pushalert_style_css', plugins_url('style.css', __FILE__), array(), $pa_version);
    wp_register_script('pushalert_javascript_js', plugins_url('javascript.js', __FILE__), array(), $pa_version);
...
function pushalert_send_notifications_callback() {
    ...
    echo'   <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    <textarea name="woocommerce_pushalert_send_notification_message" rows="3" id="woocommerce_pushalert_send_notification_message" placeholder="Notification Message" class="pushalert-woocommerce-text" required></textarea>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row" class="titledesc">
