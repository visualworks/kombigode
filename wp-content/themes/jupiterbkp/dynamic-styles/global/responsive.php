...
@media handheld, only screen and (min-width: {$min_responsive_nav_width}px) {
	...
	/* Full width layout. */
	.vertical-header-left .full-width-layout .theme-content > .mk-fullwidth-true,
	.vertical-header-left .full-width-layout .theme-content > .mk-page-section-wrapper {
		margin-left: -285px;
	}
	...
	/* Full width layout. */
	.vertical-header-right .full-width-layout .theme-content > .mk-fullwidth-true,
	.vertical-header-right .full-width-layout .theme-content > .mk-page-section-wrapper {
		margin-right: -285px;
	}
